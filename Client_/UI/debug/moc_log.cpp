...
QT_MOC_LITERAL(1, 4, 7), // "toLogon"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 5) // "login"

    },
    "Log\0toLogon\0\0login"
};
...
void Log::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Log::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Log::toLogon)) {
                *result = 0;
                return;
            }
        }
