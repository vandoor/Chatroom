...
QT_MOC_LITERAL(1, 11, 20), // "fileSendSuccessfully"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 23) // "fileReceiveSuccessfully"

    },
    "FileServer\0fileSendSuccessfully\0\0"
    "fileReceiveSuccessfully"
};
...
void FileServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->fileSendSuccessfully(); break;
        case 1: _t->fileReceiveSuccessfully(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileServer::fileSendSuccessfully)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (FileServer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileServer::fileReceiveSuccessfully)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FileServer::fileSendSuccessfully()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void FileServer::fileReceiveSuccessfully()
{
